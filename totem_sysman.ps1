...
The SHA256 check included in the script is not a promise of lack of malware and is not fool proof, users should check the script thoroughly before leveraging.  
